            ...
            <div className="resume-items">
              ...
              <div className="resume-item content-box">
                ...
                <div className="text">
                  <ul>
                    <li>
                      Developed rapid prototypes for internal healthcare initiatives using Lean Startup methodology to accelerate product validation.
                    </li>
                    <li>
                      Collaborated closely with UX research teams to build intuitive interfaces, reducing support volume.
                    </li> 
                    <li>
                      Optimized application performance through systematic debugging and codebase improvements.
                    </li>
                    <li>
                      Created data visualization tools for team performance tracking.
                    </li>                                                                                                                                              
                  </ul> 
                </div>
              </div>
              <div className="resume-item content-box">
                ...
                <div className="text">
                  <ul>
                    ...
                    <li>
                      Managed long-term client partnerships, handling maintenance, updates, and feature additions.
                    </li>                                                                                                                                              
                  </ul> 
                </div>
              </div>                                        
